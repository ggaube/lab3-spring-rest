...
public class CourseController {
	...
	// HttpStatus.NO_CONTENT corresponds to an HTTP status code 204
	// HTTP status code 204 indicates that the server has successfully processed the
	// request and that there is no content to send in the response payload
	@PutMapping("{id}")
